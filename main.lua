...
BRONZE_MEDAL = love.graphics.newImage('medals/bronze.png')
SILVER_MEDAL = love.graphics.newImage('medals/silver.png')
GOLD_MEDAL = love.graphics.newImage('medals/gold.png')
